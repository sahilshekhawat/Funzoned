Created using deprecated Web Speech API to convert speech to text and let the user surf the net, write emails and type without touching the keyboard or mouse.
Created by:
